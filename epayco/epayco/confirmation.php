...
echo "Connected Successfully...."; 
    ...
    $x_extra3 = trim($_REQUEST['x_extra3']);
    $order_id = $x_extra3;
    $queryOrder = "SELECT tab1.item_id as product_id, tab1.order_item_name,
            ...
            INNER JOIN mry7d_kart_orders tab3 
                        ...
                        if (mysqli_query($conn, $sql)) {
                            foreach($row as $orderData){
                                if((int)($orderData['3'])>0){
                                    ...
                                    $sqlUptadeStock = "UPDATE ".$pf."kart_items SET `stock` = '".$stockValue."' WHERE `product_id` = '".(int)$orderData['0']."'"; 
